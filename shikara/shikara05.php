...
<html>
<head>
<title>Iconic NPC Shikara Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_shikara.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_shikara_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Shikara Character Constructor
	*/
	function Character() {
    ...
    let healer = getShikara();
     ...
     /*getShikara() return the statistics for the healer per level*/  
    function getShikara() {
	let healer = [
	...
	return healer[4]; 
       ...
       let imgData = "images/shikara_character_sheet.png";
