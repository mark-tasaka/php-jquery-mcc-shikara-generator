...
<html>
<head>
<title>Launch Page: Shikara Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
		<form action="" id ="shikaraForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Shikara, Level 1</option>
				<option value="02">Shikara, Level 2</option>
				<option value="03">Shikara, Level 3</option>
				<option value="04">Shikara, Level 4</option>
				<option value="05">Shikara, Level 5</option>
				<option value="06">Shikara, Level 6</option>
				<option value="07">Shikara, Level 7</option>
				<option value="08">Shikara, Level 8</option>
				<option value="09">Shikara, Level 9</option>
				<option value="10">Shikara, Level 10</option>
			  </select>
        ...
        {
            $("#shikaraForm").attr('action', "shikara/shikara"+ $("#level").val() +  ".php");
        });
